...
permalink: /guide/ji-chu-zhi-shi-xue-xi/setup/
foo: foo
tags:
    - Java
    - 软件
...
**进阶优化参数 <Badge type="important" text="适用于Java 17+" />:**
...
| Bukkit | 插件服 | 最早的插件API<Badge type="warning" text="停更" /> | 历史项目 |
...
> 详情见第三节：[服务器核心入门](/guide/ji-chu-zhi-shi-xue-xi/server-core/)
...
搭建和运营一个Minecraft服务器是一个持续学习的过程。本教程涵盖了搭建服务器的所有基础知识，但实际运营中你会遇到各种各样的新问题和挑战。
